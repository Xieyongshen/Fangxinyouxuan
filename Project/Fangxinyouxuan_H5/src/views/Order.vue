    ...
    <div class="order">
        ...
        <flexbox :gutter="0" class="order-flexbox">
            <flexbox-item class="order-flexbox-item">
                ...
                <div class="order-flexbox-count">
                    <countup :start-val="1" :end-val="8888" :duration="1"></countup>单
                </div>
            </flexbox-item>
            <flexbox-item class="order-flexbox-item">
        ...
        <div class="order-search">
            ...
            <div class="order-list-all" v-if="type == 0">
                <div class="order-list-item" v-for="(item, index) in searchList" :key="index">
                    ...
                    <div class="order-info">
                        ...
                        <div class="order-info-detail">
                            ...
                            <div class="order-info-more" @click="showDetails(index)">
                                <div class="order-info-more-title">详情</div>
                                <x-icon v-if="showDetail[index]" type="ios-arrow-down" size="20" class="order-info-more-icon"></x-icon>
                                <x-icon v-if="!showDetail[index]" type="ios-arrow-up" size="20" class="order-info-more-icon"></x-icon>
                            </div>
                        </div>
                    </div>
